            ...
            <div className={`max-w-[70%] ${isOwnMessage ? 'items-end' : 'items-start'} flex flex-col`}>
                ...
                {!isOwnMessage && (
                    <div className="flex items-center gap-2 mb-1 px-2">
                        {showAvatar ? (
                            <div className={`w-6 h-6 rounded-full flex items-center justify-center text-[10px] font-bold text-white shadow-sm ${['manager', 'admin', 'founder'].includes(message.sender?.role || '')
                ...
                <div
                    className={`rounded-2xl px-4 py-2.5 shadow-sm ${isOwnMessage
                        ...
                        : isBroadcast && ['manager', 'admin', 'founder'].includes(message.sender?.role || '')
