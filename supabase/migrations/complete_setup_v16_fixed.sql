...
-- FINAL COMPLETE SETUP SCRIPT (V16 - WITH RLS FIXES)
-- Includes: Core, Messaging, SMS Logs, Reporting, Voice, Sales, Gamification, Appointments, Team Management
-- AND: Full Permissions for Admin & Founder roles
-- AND: Auto-Level Progression Fix
-- NEW: SMS Logging System (sms_logs table)
-- FIXED: Activity Stream RLS Policies
-- ============================================
...
-- [V14] Add column to track when the last motivation SMS was sent
...
-- FIXED ACTIVITY LOG POLICIES (More Permissive for Dashboard)
...
-- ============================================
-- V13 NEW: AUTO-LEVEL PROGRESSION FIX
-- ============================================

-- Auto-Level Function: Calculates current_level from total_xp
...
-- Backfill: Fix all existing agents stuck at wrong levels
UPDATE public.agent_progress
...
-- 5. Note Trigger (Note XP + Achievement)
...
-- 1. Update the email in the Auth table
UPDATE auth.users
SET email = 'alisangul123@gmail.com',
    updated_at = NOW()
WHERE email = 'manager@artificagent.com';

-- 2. Update the email in the Public Profiles table
UPDATE public.profiles
SET email = 'alisangul123@gmail.com',
    updated_at = NOW()
WHERE email = 'manager@artificagent.com';

-- 3. Confirm the new email automatically
UPDATE auth.users
...
-- ============================================
-- SETUP COMPLETE!
-- ArtificAgent System V15 - SMS Logging Ready
-- ✅ Core, Messaging, SMS Logs, Reporting, Voice, Sales, Gamification
