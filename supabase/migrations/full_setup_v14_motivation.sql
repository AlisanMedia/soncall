...
-- FINAL COMPLETE SETUP SCRIPT (V14 - WITH MOTIVATION SYSTEM)
...
-- NEW: Inactivity Motivation System (last_motivation_sent column)
-- ============================================
...
-- ============================================
-- SETUP COMPLETE!
-- ArtificAgent System V14 - Motivation System Ready
-- ✅ Core, Messaging, Reporting, Voice, Sales, Gamification
-- ✅ Inactivity Motivation: Tracks last sent SMS
